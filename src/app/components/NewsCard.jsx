...
const ProjectsCard = ({ imgUrl, title, description, gitURL, previewURL}) => {
  return (
    <div>
        ...
        <div className="overlay items-center justify-center absolute top-0 left-0 w-full h-full bg-[#0D1D38] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500">
          <Link href={gitURL} className='h-14 w-14 border-2 mr-2 relative rounded-full border-[#ADB7bE] hover:border-white group/link' target='_blank'>
